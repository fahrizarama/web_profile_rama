...
class Frontend_c extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['biodata'] = $this->Frontend_m->biodata()->row(); // ->row adalah data sendiri
		$data['keahlian'] = $this->Frontend_m->keahlian()->result_array(); // ->ressult_array adalah data banyak
		...
		$data['kontak'] = $this->Frontend_m->kontak()->row();
