...
class Admin_artikel extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = "Artikel";
        $data['view_file'] = "admin/moduls/view_artikel";
        $data['result'] = $this->M_artikel->artikel_get_all()->result();
    ...
    public function add_artikel()
    {
        ...
        if ($this->M_artikel->insert($dataInsert)) {
    ...
    public function hapus_produk()
    {
        ...
        $getData = $this->M_artikel->artikel_get_all($id);
    ...
    public function edit_produk()
    {
        ...
        if ($this->M_artikel->update($id, $updateData)) {
