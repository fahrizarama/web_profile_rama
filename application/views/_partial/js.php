...
<script src="<?php echo base_url(); ?>assetsadmin/js/ace/elements.typeahed.js"></script>
...
<script src="<?php echo base_url(); ?>docs/assetsadmin/js/rainbow.js"></script>
<script src="<?php echo base_url(); ?>docs/assetsadmin/js/languange/generic.js"></script>
<script src="<?php echo base_url(); ?>docs/assetsadmin/js/languange/html.js"></script>
<script src="<?php echo base_url(); ?>docs/assetsadmin/js/languange/css.js"></script>
<script src="<?php echo base_url(); ?>docs/assetsadmin/js/languange/javascript.js"></script>
</body>
