...
?>
<?php $title = "<i class='fa fa-address-card'></i>&nbsp;Biodata"; ?>
<div>
...
<div class="row">
    <div class="col-md-12">
        <!-- <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Biodata</a>
        </div> -->

        <div id="tambahproduk" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_biodata') ?>" method="POST" enctype="multipart/form-data">
                        <input type="reset" class="hidden">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h3 class="smaller lighter blue no-margin">Tambah Biodata</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control" name="foto_biodata" id="input_foto5" required>
                                </div>
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($value->foto_biodata) { ?>
                                    <img src="<?= base_url('assets/img/' . $value->foto_biodata) ?>" width="100">
                                <?php } ?>
                            </td>
                            <td><?= $value->deskripsi ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_biodata ?>')">
                                    <i class="fa fa-edit"> Edit</i>
                                </button>
                                <!-- <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_biodata ?>')">
