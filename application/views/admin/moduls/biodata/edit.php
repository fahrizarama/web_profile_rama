...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formEditPengalaman" action="<?= base_url('Admin_biodata/edit_produk') ?>" method="POST" enctype="multipart/form-data">
            <input type="reset" class="hidden">
            <input type="hidden" name="id_biodata" value="<?= $data->id_biodata ?>">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="smaller lighter blue no-margin">Edit Biodata</h3>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="domisili" placeholder="Domisili" value="<?= $data->domisili ?>" required>
                    </div>

                    <div class="col-md-12">
                        <label>Foto Biodata</label>
                        <input type="file" class="form-control" name="foto_biodata" id="edit_input_foto5">
                    </div>
