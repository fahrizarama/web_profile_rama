...
?>
<?php $title = "<i class='fa fa-list-alt'></i>&nbsp;Pengalaman"; ?>
<div>
...
<div class="row">
    <div class="col-md-12">
        <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Pengalaman</a>
        </div>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah Pengalaman</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="judul_pengalaman" placeholder="Judul Pengalaman" required>
                                </div>

                                <div class="col-md-3">
                                    <label>Tanggal Pengalaman</label>
                                    <input type="date" class="form-control" name="tanggal_pengalaman" placeholder="Tanggal Pengalaman" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Kota pengalaman</label>
                                    <input type="text" class="form-control" name="kota_pengalaman" placeholder="Kota Pengalaman" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Foto_pengalaman</label>
                                    <input type="file" class="form-control" name="foto_pengalaman" id="input_foto5" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Deskripsi Pengalaman</label>
                                    <textarea class="form-control" name="deskripsi_pengalaman" id="input_deskripsi" placeholder="Deskripsi"></textarea>
                                </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="datatablesPengalaman">
            <thead>
                ...
                <th>Tanggal Pengalaman</th>
                <th>Kota Pengalaman</th>
            ...
            <tbody>
                ...
                if (count($result) > 0) {
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            <td><?= $start++ ?></td>
                            <td><?= $value->judul_pengalaman ?></td>
                            <td><?= $value->deskripsi_pengalaman ?></td>
                            <td><?= $value->tanggal_pengalaman ?></td>
                            <td><?= $value->kota_pengalaman ?></td>
                            <td class="text-center">
                                <?php if ($value->foto_pengalaman) { ?>
                                    <img src="<?= base_url('assets/img/' . $value->foto_pengalaman) ?>" width="100">
                                <?php } ?>
                            </td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_pengalaman ?>')">
                                    <i class="fa fa-edit"> Edit</i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_pengalaman ?>')">
